<<<<<<< Updated upstream
package com.example.moviecharactersapihk.repositories;public class CharacterRepository {
}
=======
...
public interface CharacterRepository extends JpaRepository<Character, Integer> {
    ...
    Optional<Set<Character> >findAllCharactersByFranchise(int franchiseId);
}
>>>>>>> Stashed changes
